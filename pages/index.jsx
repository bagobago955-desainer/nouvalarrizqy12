...
import { Github, Linkedin, Mail, ChevronLeft, ChevronRight, X } from "lucide-react"; // ✅ tambah X
...
export default function App() {
  ...
  const prestasiList = [
    ...
    { title: "Peraih medali Perunggu POSBASNAS 2025 bidang Matematika", img: "https://lh3.googleusercontent.com/d/1WSMzp26r0CoExmftsPv5aLCw9QmiDRNI=s600" },
    { title: "Peraih medali emas ISAC 2025 bidang Biologi", img: "https://lh3.googleusercontent.com/d/1vbuuVCYXttExdauAqzrJHaV0-x508fu8=s600" },
    { title: "Peraih medali emas OPN 2025 bidang Kimia", img: "https://lh3.googleusercontent.com/d/1jcUo6IfuWe649ZoCj59wvspdCvideNcw=s600" },
    { title: "Peraih medali emas OPN 2025 bidang Bahasa Inggris", img: "https://lh3.googleusercontent.com/d/1F0IVt2FB7jjqnFkXiaZ-pq115PXbITf_=s600" },
  ];
    ...
    <div className="min-h-screen transition-colors duration-500" style={{ background: bg }}>
      ...
      <AnimatePresence mode="wait">
        <motion.main
          ...
          className="p-8 pt-28"
        >
          {/* Semua isi section di sini (home, tentang, karya, project, prestasi) */}
          {/* ——— Sudah sama seperti versi kamu di atas ——— */}
        </motion.main>
      </AnimatePresence>
